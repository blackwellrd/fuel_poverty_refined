  ...
  fuel_poverty_workbook <- './data/fp/sub-regional-fuel-poverty-tables-2023-2021-data.xlsx'
  fuel_poverty_worksheet <- 'Table 3'
  household_deprivation_csvfile <- './data/census/census2021-ts011-oa.csv'
  output_area_lookup_file <- './data/lu/Output_Area_to_Lower_layer_Super_Output_Area_to_Middle_layer_Super_Output_Area_to_Local_Authority_District_(December_2021)_Lookup_in_England_and_Wales_v3.csv'
  icb_lookup_file <- './data/lu/Sub_ICB_Locations_to_Integrated_Care_Boards_to_NHS_England_(Region)_(April_2023)_Lookup_in_England.csv'
  postcode_file <- './data/pcd/ONSPD_MAY_2023_UK.csv'
  outputdir <- './output'
